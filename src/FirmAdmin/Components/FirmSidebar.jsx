            ...
            {expandedSections.operations && (
              <div className="space-y-1" style={{ borderBottom: '0.6px solid #FFFFFF80', paddingBottom: '16px' }}>
                <Link to="/firmadmin/documents" className={linkClass("/firmadmin/documents")}>
                  <span className={iconWrapperClass("/firmadmin/documents")} style={getIconWrapperStyle("/firmadmin/documents")}>
                    <DocumentManage />
                  </span>
                  Document Management
                </Link>
                <Link to="/firmadmin/esignature" className={linkClass("/firmadmin/esignature")}>
                  <span className={iconWrapperClass("/firmadmin/esignature")} style={getIconWrapperStyle("/firmadmin/esignature")}>
                ...
                <Link to="/firmadmin/calendar" className={linkClass("/firmadmin/calendar")}>
                  <span className={iconWrapperClass("/firmadmin/calendar")} style={getIconWrapperStyle("/firmadmin/calendar")}>
                    <Schedule />
                  </span>
                  Scheduling & Calendar
                </Link>
            ...
            {expandedSections.businessOperations && (
              <div className="space-y-1" style={{ borderBottom: '0.6px solid #FFFFFF80', paddingBottom: '16px' }}>
                <Link to="/firmadmin/billing" className={linkClass("/firmadmin/billing")}>
                  <span className={iconWrapperClass("/firmadmin/billing")} style={getIconWrapperStyle("/firmadmin/billing")}>
                    <Billing />
                  </span>
                  Billing & Payments
                </Link>
                <Link to="/firmadmin/workflow" className={linkClass("/firmadmin/workflow")}>
                  <span className={iconWrapperClass("/firmadmin/workflow")} style={getIconWrapperStyle("/firmadmin/workflow")}>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-colors duration-200">
                ...
                <Link to="/firmadmin/subscription" className={linkClass("/firmadmin/subscription")}>
                  <span className={iconWrapperClass("/firmadmin/subscription")} style={getIconWrapperStyle("/firmadmin/subscription")}>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-colors duration-200">
                      <path d="M1.33398 6.66146H14.6673M2.66732 3.32812H13.334C14.0704 3.32812 14.6673 3.92508 14.6673 4.66146V11.3281C14.6673 12.0645 14.0704 12.6615 13.334 12.6615H2.66732C1.93094 12.6615 1.33398 12.0645 1.33398 11.3281V4.66146C1.33398 3.92508 1.93094 3.32812 2.66732 3.32812Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
            ...
            {expandedSections.systemSecurity && (
              <div className="space-y-1" style={{ borderBottom: '0.6px solid #FFFFFF80', paddingBottom: '16px' }}>
                ...
                <Link to="/firmadmin/security" className={linkClass("/firmadmin/security")}>
                  <span className={iconWrapperClass("/firmadmin/security")} style={getIconWrapperStyle("/firmadmin/security")}>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-colors duration-200">
