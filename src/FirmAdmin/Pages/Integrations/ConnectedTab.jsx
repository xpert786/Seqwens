        ...
        {integrations.map((integration) => (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <button className="flex-1 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-[#1F2A55] bg-white !border border-[#E8F0FF] !rounded-lg transition font-[BasisGrotesquePro] flex items-center justify-center gap-1.5 sm:gap-2">
