...
const WorkflowPipelineView = ({
    ...
    // Filter instances by search and status
    const filteredInstances = instances.filter(instance => {
        ...
        const matchesSearch = !searchTerm ||
            (instance.tax_case_name || '').toLowerCase().includes(searchTerm.toLowerCase()) ||
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <div className="relative">
                            <input
                                ...
                                className="pl-10 pr-4 py-2.5 !border border-[#E8F0FF] !rounded-lg focus:ring-2 focus:ring-[#3AD6F2] focus:border-transparent font-[BasisGrotesquePro] w-full sm:w-64"
                            />
