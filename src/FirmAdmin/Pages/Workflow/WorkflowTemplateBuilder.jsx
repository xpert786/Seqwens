        ...
        <div className="bg-white !rounded-lg !border border-[#E8F0FF] p-5 mb-6">
                  ...
                  <div className="flex items-start gap-2 mb-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className={`text-xs px-2 py-0.5 rounded-full ${userInfo.color}`}>
          ...
          <div className="mt-4 pt-4 border-t border-[#E8F0FF]">
            <button
              ...
              className="w-full py-3 !border-2 border-dashed border-[#E8F0FF] !rounded-lg text-[#3AD6F2] hover:border-[#3AD6F2] hover:bg-[#F0FDFF] font-[BasisGrotesquePro] font-medium flex items-center justify-center gap-2"
            >
