        ...
        },
        {
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M14 6H4C2.89543 6 2 6.89543 2 8V16C2 17.1046 2.89543 18 4 18H14C15.1046 18 16 17.1046 16 16V8C16 6.89543 15.1046 6 14 6Z" stroke="#3AD6F2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                                        ...
                                        {calendarDays.map((day, index) => (
                                            ...
                                            {day.date === 21 && day.isCurrentMonth && (
                                                <div className="mt-4 sm:mt-6">
                                                    <div className="bg-[#FFF5E0] border border-[#FFE0B2] rounded-lg px-1.5 sm:px-2 py-1 sm:py-1.5 flex items-start gap-1.5 sm:gap-2">
