        ...
        >
          ...
          >
            ...
            <div className="flex justify-between items-start p-4 sm:p-6  sticky top-0 bg-white z-10 rounded-t-lg">
              ...
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="0.25" y="0.25" width="15.5" height="15.5" rx="2.75" fill="white" />
                  <rect x="0.25" y="0.25" width="15.5" height="15.5" rx="2.75" stroke="#E8F0FF" stroke-width="0.5" />
                  <g clip-path="url(#clip0_5150_36195)">
                    <path d="M8 5.00008H5.66667C5.48986 5.00008 5.32029 5.07031 5.19526 5.19534C5.07024 5.32036 5 5.48993 5 5.66674V10.3334C5 10.5102 5.07024 10.6798 5.19526 10.8048C5.32029 10.9298 5.48986 11.0001 5.66667 11.0001H10.3333C10.5101 11.0001 10.6797 10.9298 10.8047 10.8048C10.9298 10.6798 11 10.5102 11 10.3334V8.00008M10.125 4.87508C10.2576 4.74247 10.4375 4.66797 10.625 4.66797C10.8125 4.66797 10.9924 4.74247 11.125 4.87508C11.2576 5.00768 11.3321 5.18754 11.3321 5.37508C11.3321 5.56261 11.2576 5.74247 11.125 5.87508L8 9.00008L6.66667 9.33341L7 8.00008L10.125 4.87508Z" stroke="#3B4A66" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <defs>
                    <clipPath id="clip0_5150_36195">
