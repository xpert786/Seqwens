          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-2 lg:hidden mt-2">
                ...
                <button className="px-3 py-1.5 bg-white !border border-[#E8F0FF] !rounded-lg transition font-[BasisGrotesquePro] flex items-center gap-1.5 text-xs text-gray-700 whitespace-nowrap">
