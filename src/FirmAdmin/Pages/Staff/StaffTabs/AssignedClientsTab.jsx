...
export default function AssignedClientsTab({ assignedClients }) {
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h5 className="text-lg font-semibold text-gray-900 font-[BasisGrotesquePro]">Assigned Clients ({assignedClients.length})</h5>
          <p className="text-sm text-gray-600 font-[BasisGrotesquePro] mt-1">Clients currently managed by this staff member</p>
        </div>
