  ...
  <div className="bg-white border-t border-[#E8F0FF] px-4 sm:px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
    <div className="flex items-center justify-between w-full sm:w-auto gap-4">
      <button
        ...
        onClick={onClose}
        disabled={saving}
        className="px-4 sm:px-6 py-2.5 border border-[#E8F0FF] bg-white text-gray-700 !rounded-lg transition-colors font-[BasisGrotesquePro] text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
      >
        Cancel
      </button>
    ...
    <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
      ...
      <button
        ...
        className="w-full sm:w-auto px-6 py-2.5 bg-[#F56D2D] text-white !rounded-lg transition-colors font-[BasisGrotesquePro] text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      >
        {saving ? (
          <>
