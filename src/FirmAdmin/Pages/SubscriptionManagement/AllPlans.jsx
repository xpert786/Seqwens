...
const AllPlans = ({ currentPlanName, currentBillingCycle }) => {
    ...
    const isCurrentPlan = (plan) => {
        // If API explicitly says it is current, trust it
        if (plan.is_current === true) return true;
        ...
        if (currentBillingCycle) {
            ...
            // If user is on 'monthly' plan, and looking at 'yearly' tab, they shouldn't see 'Current Plan'
            if (userCycle !== viewCycle) return false;
        }
