                ...
                >
                  ...
                  <div className="mt-auto pt-4 sm:pt-5 border-t border-gray-200">
                    <button
                      ...
                      disabled={processing}
                      className={`w-full px-4 py-3 rounded-lg text-sm sm:text-base font-bold transition-all duration-200 font-[BasisGrotesquePro] shadow-sm flex items-center justify-center gap-2 ${isSelected
                        ? 'bg-[#F56D2D] text-white hover:bg-orange-600 shadow-orange-200'
