                                                ...
                                                {!isCurrent && (
                                                    <div className="mt-4 pt-4 border-t border-gray-100">
                                                        <button
                                                            ...
                                                            disabled={processing}
                                                            className={`w-full px-3 sm:px-4 py-2.5 !rounded-lg transition-all duration-200 font-[BasisGrotesquePro] text-xs sm:text-sm font-bold shadow-sm flex items-center justify-center gap-2 ${isSelected
