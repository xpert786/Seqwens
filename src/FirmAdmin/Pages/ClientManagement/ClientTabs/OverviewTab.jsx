          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[13px] text-[#3B4A66] font-bold font-[BasisGrotesquePro] break-words">{client.filingStatus || 'N/A'}</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-2 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                {isEditMode && editFormData ? (
                  ...
                  <div className="text-sm text-gray-900 font-[BasisGrotesquePro] break-words">{client.phone}</div>
                )}
              </div>
            </div>
            <div className="flex items-start gap-2 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                {isEditMode && editFormData ? (
                  <input
                    ...
                    className="w-full min-w-0 px-2 py-1 text-sm text-gray-900 border border-[#E8F0FF] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3AD6F2] font-[BasisGrotesquePro]"
                  />
                ) : (
                  <div className="text-sm text-gray-900 font-[BasisGrotesquePro] break-words">{client.email}</div>
                )}
              </div>
            </div>
          </div>
