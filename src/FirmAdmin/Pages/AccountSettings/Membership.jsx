...
import { roleAPI, userAPI, handleAPIError } from "../../../ClientOnboarding/utils/apiUtils";
...
export default function Membership() {
    ...
    useEffect(() => {
        const fetchRoles = async () => {
            try {
                ...
                if (response.success) {
                    // Normalize roles data from available-contexts endpoint
                    // This endpoint typically returns { all_roles: [...], needs_role_selection: ... }
                    let rolesData = [];
                    ...
                    // Set currently active role as initial selection
    ...
    const handleSwitchRole = async () => {
        ...
        // Find if selected role is already active
    ...
    if (loading) {
        return (
            <div className="bg-white rounded-lg shadow-sm border p-8">
                ...
                <p className="text-center text-gray-400 mt-8 font-[BasisGrotesquePro]">Loading your workspace options...</p>
            </div>
        );
    }
