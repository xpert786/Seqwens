                                ...
                                {settingsLoading ? (
                                    ...
                                    <form className="mt-6 space-y-6" onSubmit={(e) => { e.preventDefault(); handleSubmitSettings(); }}>
                                        ...
                                        <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                                            <h6 className="text-base font-semibold text-gray-900 dark:text-white mb-4">
                                                Developer Settings
                                            </h6>
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <p className="text-xs text-blue-700 dark:text-blue-400">
                                                        Grant full access to all features (OCR, AI, etc.) for testing internal workflows.
                                                        Bypasses all billing limits.
                                                    </p>
                                                </div>
