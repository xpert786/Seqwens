                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <button
                                    ...
                                    className="mt-4 inline-flex items-center rounded-lg bg-red-100 px-3 py-2 text-xs font-medium text-red-700 transition-colors"
                                >
                                    Try again
                                </button>
                            </div>
                            ...
                            <div className="rounded-xl p-6" style={{ backgroundColor: 'var(--sa-bg-card, #ffffff)' }}>
                                <div className="flex items-start justify-between gap-4 firmdetails-settings-header">
                                    ...
                                    <button
                                        ...
                                        className="flex h-8 w-8 items-center justify-center rounded-full bg-[#F6F8FE] dark:bg-gray-700 text-[#94A3B8] dark:text-gray-400 transition-colors dark:disabled:opacity-50"
                                        title="Reset changes"
                                    >
                                    ...
                                    <form className="mt-6 space-y-6" onSubmit={(e) => { e.preventDefault(); handleSubmitSettings(); }}>
                                        ...
                                        <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                                            ...
                                            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 !dark:bg-slate-800 border border-slate-200 !dark:border-gray-700 shadow-sm">
                                                <div>
                                                    ...
                                                    <p className="text-[11px] text-gray-600 !dark:text-gray-400 leading-relaxed max-w-md">Grant full access to all features (OCR, AI, etc.) for testing internal workflows. Bypasses all billing limits.</p>
                                                </div>
                                        ...
                                        <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end firmdetails-settings-actions">
                                            ...
                                            <button
                                                ...
                                                className="border border-[#E2E8F0] dark:border-gray-600 inline-flex items-center justify-center rounded-lg bg-white dark:bg-gray-700 px-5 py-2 text-sm font-semibold text-[#475569] dark:text-gray-300 transition-colors dark:disabled:opacity-50"
                                                style={{ borderRadius: '8px' }}
                                            >
                                                Cancel
                                            </button>
                                            <button
                                                type="submit"
                                                disabled={settingsSaving}
                                                className="inline-flex items-center justify-center rounded-lg px-5 py-2 text-sm font-semibold text-white bg-[#F56D2D] dark:bg-orange-600 transition-colors dark:disabled:opacity-50"
                                                style={{ borderRadius: '8px' }}
                                            >
                ...
                {!loading && firmDetails && (
                    <div className="flex justify-center pt-6 pb-4">
                        <button
                            ...
                            onClick={handleFirmLogin}
                            disabled={loggingIn}
                            className="inline-flex items-center gap-2 rounded-lg bg-[#3B4A66] px-6 py-3 text-sm font-semibold text-white transition-colors focus:outline-none focus:ring-2 focus:ring-[#3B4A66] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                            style={{ borderRadius: '8px' }}
                        >
                            {loggingIn ? (
                                <>
            ...
            <div className="rounded-xl border border-red-200 bg-red-50 p-6">
                <div className="flex flex-col gap-3">
                    ...
                    <button
                        type="button"
                        onClick={onRetry}
                        className="inline-flex items-center gap-2 self-start rounded-lg bg-red-100 px-3 py-2 text-xs font-semibold text-red-700">
                        Retry
                    </button>
                </div>
            </div>
