  ...
  return (
    <section className="max-w-7xl mx-auto px-3 sm:px-4 md:px-5 py-8 sm:py-12 md:py-16">
      ...
      <div className="text-center space-y-2 sm:space-y-3 mb-8 sm:mb-12 md:mb-16">
        <p className="text-gray-500 text-xs sm:text-sm font-medium">AI–Powered</p>

        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#3B4A66] leading-tight px-2">
          SUPERCHARGE YOUR PRACTICE WITH
        </h2>

        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold !text-[#F49C2D] px-2">
          ARTIFICIAL INTELLIGENCE
        </h2>

        <p className="text-[#3B4A66] text-sm sm:text-base max-w-3xl mx-auto mt-4 sm:mt-6 px-2">
          Our advanced AI tools automate repetitive tasks, extract data with precision, and provide insights<br className="hidden sm:block" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-start">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div
            ...
            className={`rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 flex gap-3 sm:gap-4 md:gap-5 items-start cursor-pointer transition-all duration-300 ${activeFeature === 0
              ? 'border-2 border-[#FFD8BC] bg-[#FFF9F0] shadow-sm'
              : 'border-2 border-transparent hover:border-gray-200'
              }`}
          >
            <div className="flex-shrink-0">
              <svg className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="54" height="54" rx="15" fill="#00C0C6" />
                <path d="M22.5001 15C22.8284 15 23.1535 15.0647 23.4568 15.1903C23.7601 15.3159 24.0357 15.5001 24.2678 15.7322C24.5 15.9644 24.6841 16.24 24.8098 16.5433C24.9354 16.8466 25.0001 17.1717 25.0001 17.5V32.5C24.9987 33.1239 24.7642 33.7247 24.3425 34.1845C23.9208 34.6442 23.3424 34.9297 22.721 34.9848C22.0996 35.04 21.48 34.8607 20.9839 34.4824C20.4879 34.104 20.1512 33.5539 20.0401 32.94C19.6212 33.0333 19.1854 33.0171 18.7745 32.8931C18.3637 32.7691 17.9917 32.5415 17.6943 32.232C17.3969 31.9226 17.1842 31.5419 17.0767 31.1264C16.9691 30.711 16.9703 30.2749 17.0801 29.86C16.5049 29.6753 15.9989 29.3212 15.6284 28.8441C15.2578 28.367 15.0399 27.7892 15.0031 27.1862C14.9664 26.5832 15.1125 25.9832 15.4224 25.4647C15.7324 24.9461 16.1916 24.5332 16.7401 24.28C16.414 23.9578 16.1827 23.5522 16.0716 23.1075C15.9605 22.6628 15.9738 22.1961 16.1101 21.7584C16.2463 21.3207 16.5003 20.9289 16.8442 20.6259C17.1881 20.3228 17.6087 20.1201 18.0601 20.04C17.9873 19.7126 17.9811 19.3739 18.0419 19.0441C18.1027 18.7143 18.2292 18.4001 18.4139 18.1201C18.5987 17.8402 18.8378 17.6003 19.1172 17.4148C19.3966 17.2292 19.7104 17.1018 20.0401 17.04C20.1475 16.4663 20.4523 15.9482 20.9016 15.5756C21.3509 15.203 21.9164 14.9994 22.5001 15Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M27.5 15C26.837 15 26.2011 15.2634 25.7322 15.7322C25.2634 16.2011 25 16.837 25 17.5V32.5C25.0013 33.1239 25.2359 33.7247 25.6576 34.1845C26.0793 34.6442 26.6577 34.9297 27.2791 34.9848C27.9005 35.04 28.5201 34.8607 29.0161 34.4824C29.5122 34.104 29.8489 33.5539 29.96 32.94C30.3789 33.0333 30.8147 33.0171 31.2256 32.8931C31.6364 32.7691 32.0084 32.5415 32.3058 32.232C32.6031 31.9226 32.8158 31.5419 32.9234 31.1264C33.031 30.711 33.0298 30.2749 32.92 29.86C33.4952 29.6753 34.0011 29.3212 34.3717 28.8441C34.7423 28.367 34.9602 27.7892 34.997 27.1862C35.0337 26.5832 34.8876 25.9832 34.5776 25.4647C34.2677 24.9461 33.8085 24.5332 33.26 24.28C33.5861 23.9578 33.8173 23.5522 33.9285 23.1075C34.0396 22.6628 34.0263 22.1961 33.89 21.7584C33.7538 21.3207 33.4998 20.9289 33.1559 20.6259C32.812 20.3228 32.3913 20.1201 31.94 20.04C32.0128 19.7126 32.019 19.3739 31.9582 19.0441C31.8974 18.7143 31.7709 18.4001 31.5862 18.1201C31.4014 17.8402 31.1622 17.6003 30.8829 17.4148C30.6035 17.2292 30.2896 17.1018 29.96 17.04C29.8526 16.4663 29.5478 15.9482 29.0985 15.5756C28.6492 15.203 28.0837 14.9994 27.5 15Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              <h5 className="font-bold text-sm sm:text-base text-[#3B4A66] mb-1 sm:mb-2 leading-tight">
                SMART DOCUMENT CLASSIFICATION
              </h5>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                AI automatically categorizes uploaded documents by type, saving<br className="hidden sm:block" />hours of manual sorting.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            className={`rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 flex gap-3 sm:gap-4 md:gap-5 items-start cursor-pointer transition-all duration-300 ${activeFeature === 1
              ? 'border-2 border-[#FFD8BC] bg-[#FFF9F0] shadow-sm'
              : 'border-2 border-transparent hover:border-gray-200'
              }`}
          >
            <div className="flex-shrink-0">
              <svg className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="54" height="54" rx="15" fill="#00C0C6" />
                <path d="M31 17H19C17.8954 17 17 17.8954 17 19V31C17 32.1046 17.8954 33 19 33H31C32.1046 33 33 32.1046 33 31V19C33 17.8954 32.1046 17 31 17Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M28 22H22V28H28V22Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M28 15V17" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M28 33V35" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M15 28H17" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M15 22H17" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M33 28H35" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M33 22H35" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M22 15V17" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M22 33V35" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              <h5 className="font-bold text-sm sm:text-base text-[#3B4A66] mb-1 sm:mb-2 leading-tight">
              ...
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                Extract key information from tax forms and documents with high<br className="hidden sm:block" />accuracy.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            className={`rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 flex gap-3 sm:gap-4 md:gap-5 items-start cursor-pointer transition-all duration-300 ${activeFeature === 2
              ? 'border-2 border-[#FFD8BC] bg-[#FFF9F0] shadow-sm'
              : 'border-2 border-transparent hover:border-gray-200'
              }`}
          >
            <div className="flex-shrink-0">
              <svg className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="54" height="54" rx="15" fill="#00C0C6" />
                <path d="M25 16L23.088 21.813C22.9901 22.1105 22.8238 22.3809 22.6023 22.6023C22.3809 22.8238 22.1105 22.9901 21.813 23.088L16 25L21.813 26.912C22.1105 27.0099 22.3809 27.1762 22.6023 27.3977C22.8238 27.6191 22.9901 27.8895 23.088 28.187L25 34L26.912 28.187C27.0099 27.8895 27.1762 27.6191 27.3977 27.3977C27.6191 27.1762 27.8895 27.0099 28.187 26.912L34 25L28.187 23.088C27.8895 22.9901 27.6191 22.8238 27.3977 22.6023C27.1762 22.3809 27.0099 22.1105 26.912 21.813L25 16Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M18 16V20" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M32 30V34" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M16 18H20" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M30 32H34" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              <h5 className="font-bold text-sm sm:text-base text-[#3B4A66] mb-1 sm:mb-2 leading-tight">
              ...
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                Identify unusual patterns or potential errors in financial data before<br className="hidden sm:block" />they become issues.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            className={`rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 flex gap-3 sm:gap-4 md:gap-5 items-start cursor-pointer transition-all duration-300 ${activeFeature === 3
              ? 'border-2 border-[#FFD8BC] bg-[#FFF9F0] shadow-sm'
              : 'border-2 border-transparent hover:border-gray-200'
              }`}
          >
            <div className="flex-shrink-0">
              <svg className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="54" height="54" rx="15" fill="#00C0C6" />
                <path d="M35 20L26.5 28.5L21.5 23.5L15 30" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M29 20H35V26" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div>
              <h5 className="font-bold text-sm sm:text-base text-[#3B4A66] mb-1 sm:mb-2 leading-tight">
        ...
        >
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-5 space-y-2 sm:space-y-3 border-2 border-white/30">

            <h3 className="text-white font-bold text-xs sm:text-sm mb-2 sm:mb-3 uppercase tracking-wider">SMART DOCUMENT</h3>

            {/* File Row */}
            <div className="flex justify-between items-center bg-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg shadow-lg gap-2">
              <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-1">
                <div className="w-4 h-4 sm:w-5 sm:h-5 text-[#00C0C6] flex-shrink-0">
                  <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M11.688 3.11035V8.77035C11.688 9.30079 11.8987 9.80949 12.2738 10.1846C12.6488 10.5596 13.1576 10.7704 13.688 10.7704H19.35" stroke="#00C0C6" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <span className="text-gray-700 text-[10px] sm:text-xs font-medium truncate">abc.pdf</span>
              </div>

              {/* Download Button with dropdown icon */}
              <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
                <button className="text-white bg-[#F56D2D] px-2 sm:px-3 py-1 !rounded-md text-[10px] sm:text-xs font-bold hover:bg-[#E55D1D] transition-colors">
                  Download
                </button>
                <button className="text-[#F56D2D] text-sm sm:text-lg font-bold hover:text-[#E55D1D]">
            ...
            <div className="space-y-2 sm:space-y-3 mt-3 sm:mt-4">
              <div className="h-8 sm:h-10 bg-gradient-to-r from-white/15 to-white/25 backdrop-blur-sm rounded-lg border border-white/40"></div>
              <div className="h-8 sm:h-10 bg-gradient-to-r from-white/15 to-white/25 backdrop-blur-sm rounded-lg border border-white/40"></div>
              <div className="h-8 sm:h-10 bg-gradient-to-r from-white/15 to-white/25 backdrop-blur-sm rounded-lg border border-white/40"></div>
              <div className="h-8 sm:h-10 bg-gradient-to-r from-white/15 to-white/25 backdrop-blur-sm rounded-lg border border-white/40"></div>
            </div>
