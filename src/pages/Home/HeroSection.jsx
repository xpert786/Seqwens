...
export default function HeroSection() {
  ...
  return (
    <div className="">
      <main className="flex-1 w-full px-3 sm:px-6 lg:px-10 xl:px-12 py-0">
        <section
          className="w-full mx-auto rounded-[40px] font-[BasisGrotesquePro]
        ...
        >
          ...
          <div className="flex flex-col items-center text-center gap-6 max-w-3xl mx-auto">
            <h1 className="text-[38px] md:text-[54px] font-extrabold leading-tight tracking-wide text-white">
              TRANSFORM YOUR <span className="text-[#FFB84D]">TAX</span><br />
              PRACTICE
            </h1>

            <p className="text-[18px] text-[#D9E8FF] max-w-2xl leading-relaxed mt-2">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-2">
              <button className="px-7 py-2 !rounded-lg bg-white text-[#0B1F3A] font-semibold  text-[15px]">
                Request Demo
              </button>

              <button className="px-7 py-2 !rounded-lg bg-[#FF7A2E] text-white font-semibold shadow-lg flex items-center gap-2 text-[15px]">
                Take a Tour
          ...
          <div className="w-full flex justify-center mt-12">
            <div className="bg-white/90 rounded-[30px] p-2">
              <div className="relative rounded-[26px] overflow-hidden aspect-video w-[900px] max-w-full bg-[#E8EEF7] flex items-center justify-center">
                <img
                  src={heroImage}
                ...
                <button className="absolute w-[70px] h-[70px] bg-white rounded-full flex items-center justify-center shadow-xl hover:scale-105 transition">
                  <span className="text-2xl text-[#0B1F3A]">
          ...
          <div className="w-full mt-16 text-center">
            ...
            {/* Logos Row */}
            <div className="w-full flex flex-wrap justify-center gap-20 mt-10 opacity-85">
