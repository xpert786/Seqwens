        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full min-h-screen relative z-10">
          <div className="px-8 lg:px-16 xl:px-20 flex flex-col justify-center py-20 lg:py-0">
            <div data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-out-cubic" data-aos-delay="300">
              <div className="backdrop-blur-xs py-4 rounded-xl border border-zinc-800/30 inline-block mb-6 max-w-[420px]" data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-out-cubic" data-aos-delay="500">
                <div className="flex items-center">
                  ...
                  <div className="flex flex-col mx-3 gap-1">
                    <h3 className="text-sm font-medium text-white" style={{fontSize:"16px"}}>#AI Tax Practice Management Platform</h3>
            ...
            <h1 className="text-5xl lg:text-8xl xl:text-8xl font-bold mb-8 leading-[1.1] text-white" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-out-cubic" data-aos-delay="600" style={{fontSize:"70px"}}>
              Run Your Entire Tax Office With AI-Powered Precision
            </h1>
            <p className=" text-lg lg:text-xl text-zinc-300 max-w-xl leading-relaxed" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-out-cubic" data-aos-delay="800">
