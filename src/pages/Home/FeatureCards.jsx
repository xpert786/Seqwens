      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16" style={{ opacity: 1, transform: "none" }}>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-12 text-white  leading-tight">User SatisfactionTransform Your Tax Practice Into a Scalable Operation</h1>
          </div>
          <div className="space-y-8 text-lg md:text-xl text-zinc-300 max-w-3xl mx-auto">
            ...
            <div className="text-center pt-8" style={{ opacity: 1, transform: "none" }}>
              ...
              </p><a href="/sign-in"><button className="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 h-11 rounded-md bg-white hover:bg-zinc-100 text-black px-8 py-6 text-lg font-semibold transition-all duration-300 transform hover:scale-105">Get Started Today</button></a>
