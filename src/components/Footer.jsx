...
export default function Footer() {
    return (
        <footer className="w-full bg-[#3B4A66] text-white rounded-t-3xl">
            <div className="max-w-[1300px] mx-auto px-6 md:px-8 lg:px-10 py-12 md:py-16">
                <div className="grid grid-cols-1 lg:grid-cols-[420px_auto] gap-10 lg:gap-16 items-start">
                    ...
                    <div className="w-full">
                        <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-sm">
                            ...
                            {/* Description */}
                            <p className="text-[#3D4756] text-sm md:text-base mb-6 font-[BasisGrotesquePro] leading-relaxed">
                            ...
                            {/* Follow us */}
                            <p className="text-[#3D4756] text-sm font-[BasisGrotesquePro] mb-3">
                                Follow us on:
                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12 mt-8">

                        {/* PRODUCT Column */}
                        <div>
                            <h3 className="text-white font-bold text-sm md:text-base mb-4 font-[BasisGrotesquePro] uppercase tracking-wider ml-6">
                                PRODUCT
                            </h3>
                            <ul className="space-y-3">
                                <li>
                                    <Link to="/features" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Features
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/capabilities" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        AI Capabilities
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/pricing" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Pricing
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/security" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Security
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/integrations" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Integrations
                                    </Link>
                                </li>
                            </ul>
                        ...
                        {/* RESOURCES Column */}
                        <div>
                            <h3 className="text-white font-bold text-lg md:text-base mb-4 font-[BasisGrotesquePro] uppercase tracking-wider ml-6">
                                RESOURCES
                            </h3>
                            <ul className="space-y-3">
                                <li>
                                    <Link to="/case-studies" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Case Studies
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/articles" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Articles
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/help" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Help Center
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/documentation" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Documentation
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/api" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        API Reference
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li>
                                    <Link to="/about" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        About
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/careers" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Careers
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/contact" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Contact
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/partners" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Partners
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/press" className="text-white hover:text-white/90 text-lg font-[BasisGrotesquePro] transition-colors">
                                        Press
                                    </Link>
                                </li>
                            </ul>
                ...
                {/* White divider line */}
                <hr className="!mt-12 border-t border-white " />

                {/* Bottom Section - Copyright and Policy Links */}
                <div className="pt-4 pb-4 md:py-5 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-white text-sm font-[BasisGrotesquePro]">
                        © 2024 SeQwens. All rights reserved.
                    </p>
                    <div className="flex items-center gap-4 text-sm font-[BasisGrotesquePro]">
