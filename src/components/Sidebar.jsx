...
import { DashIcon, FileIcon, BalanceIcon, MesIcon, IntakeIcon, MonthIcon, AccountIcon, LogOutIcon, HelpsIcon } from "../components/icons";
...
export default function Sidebar() {
  ...
  return (
    <div className="sidebar-container d-flex flex-column justify-content-between">
      {/* Top Navigation */}
      <ul className="nav flex-column mb-auto px-3 ">
