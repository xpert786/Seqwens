            ...
            <div className="bg-white rounded-lg p-6 w-96 max-w-md mx-4 shadow-xl relative animate-forcedPwFadeIn"
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-2.5 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                        style={{ fontFamily: 'BasisGrotesquePro, sans-serif' }}
                    >
                        {loading ? (
