    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 p-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-white mb-6 text-center">Interactive Elements</h2>
        ...
        <div className="bg-white rounded-2xl p-8 mb-8 shadow-2xl">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">Typography Test</h2>
          
          <div className="space-y-4">
            <h1 className="text-5xl font-black text-purple-600">Heading 1 - Black</h1>
            <h2 className="text-4xl font-bold text-blue-600">Heading 2 - Bold</h2>
        ...
        {/* Grid Layout Test */}
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 mb-8">
          <h2 className="text-3xl font-bold text-white mb-6 text-center">Grid Layout Test</h2>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Animation Test</h2>
